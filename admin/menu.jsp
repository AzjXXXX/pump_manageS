	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>车辆信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
                 <li><a href='<%=path %>/admin/bumen/bumenAdd.jsp' target='main'>车辆信息添加</a> </li>
                 <li><a href='<%=path %>/bumen?type=bumenMana' target='main'>车辆信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>	      
	      <dl class='bitem'>
